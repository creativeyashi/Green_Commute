...
export const VEHICLE_TAB = {
  METRO_TEXT: 'Catch a blue line metro towards Raidurg',
  GOOGLE_MAPS: 'View in Google Maps',
}
...
export const FINDJOBS_HEADING = 'Find Jobs'
export const FINJOBS_FILTER = 'Filter'
export const ROUTES = 'Commute routes available :'
